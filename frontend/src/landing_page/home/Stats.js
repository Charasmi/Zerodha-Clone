            ...
            <div className='row p-5'>
                ...
                <div className='col-6 p-5'>
                    ...
                    <div className='text-center'>
                        <a href=''className='mx-5' style={{textDecoration:"none"}}>Explore our products <i class="fa fa-arrow-right"></i></a>
                        <a href='' style={{textDecoration:"none"}}>Try kite demo <i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
